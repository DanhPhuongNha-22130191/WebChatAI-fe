...
export const getAvatarUrl = (name, size = 128, avatar) => {
    ...
    return `https://ui-avatars.com/api/?name=${encodeURIComponent(displayName)}&background=${color}&size=${size}`;
};
